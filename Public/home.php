...
$loginUrl    = homepageUrl('login');
$registerUrl = homepageUrl('register');
$homeUrl     = homepageUrl('');
...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= htmlspecialchars(homepageUrl('Public/assets/img/favicon-48x48.png'), ENT_QUOTES, 'UTF-8') ?>">
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars(homepageUrl('Public/assets/CSS/style.css'), ENT_QUOTES, 'UTF-8') ?>">
</head>
